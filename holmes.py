...
print("{word1} {word2} {word3} {word4} {word5}.".format(word1 = stochastic_random_word(histo_holmes), word2 = random_word_from_histogram(histo_holmes), word3 = random_word_from_histogram(histo_holmes), word4 = stochastic_random_word(histo_holmes), word5 = random_word_from_histogram(histo_holmes)))
